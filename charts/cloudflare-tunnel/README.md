...
![AppVersion: 2025.2.1](https://img.shields.io/badge/AppVersion-2025.2.1-informational?style=flat)
...
[here](https://github.com/plcnk/charts/issues/new?assignees=plcnk&labels=bug&template=bug_report.yaml&name=cloudflare-tunnel&version=0.7.1)**
...
| controllers.main.containers.app.image.tag | string | `"2025.2.1"` | Image tag |
