...
![Version: 0.9.12](https://img.shields.io/badge/Version-0.9.12-informational?style=flat)
![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat)
![AppVersion: 2.5.308](https://img.shields.io/badge/AppVersion-2.5.308-informational?style=flat)
...
[here](https://github.com/plcnk/charts/issues/new?assignees=plcnk&labels=bug&template=bug_report.yaml&name=wikijs&version=0.9.12)**
...
| controllers.main.containers.app.image.tag | string | `"2.5.308"` | Image tag |
